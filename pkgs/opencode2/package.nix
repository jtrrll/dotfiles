...
let
  nodeModulesHashes = {
    aarch64-darwin = "wAea8+jajnMDxZ6XJL+Hsrf0621hwtBtWyD1+dS45dE=";
    aarch64-linux = "Wc8OT2DRZpVo56KaoGE0Hsj1NDknakbWXO9w2qy6j+0=";
    x86_64-linux = "U9IuP/ev6w4urvogOwQyl3rdumY6W4YaY18NkFaOVHU=";
  };
in
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-9sZ8akR8S4U7Ff0H+CbpGxbFu2U043aKCCx306TOUGs=";
  };
