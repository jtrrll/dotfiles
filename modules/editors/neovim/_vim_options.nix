  ...
  config = {
    programs.nixvim.opts =
      ...
      in
      {
        ...
        colorcolumn = lib.concatStringsSep "," (map toString lineLengthRulers); # highlight columns
        ...
        scrolloff = linesAroundCursor; # number of lines to preserve above/below the cursor
        shiftround = true; # indent to nearest indent level
        shiftwidth = indentWidth; # spaces per indent level
        ...
        tabstop = indentWidth; # number of spaces per tab
